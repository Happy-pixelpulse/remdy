...
class Data {
  ...
  final List<PostgraduateTraining?>? postgraduateTraining;
  final List<RegistrationHistory?>? registrationHistory;
  final List<String?>? hospitalPrevilages;
  final List<String?>? insurancePlansAccepted;
  Data({
required this.id,
required this.name,
  ...
  factory Data.fromJson(Map<String, dynamic> json) {
    return Data(
      ...
      specialities: (json['specialities'] as List)
          .map((specialities) =>
          Specialities.fromJson(specialities))
          .toList(),
      postgraduateTraining: (json['postgraduate_training'] as List)
          .map((postQualifications) =>
          PostgraduateTraining.fromJson(postQualifications))
          .toList(),
      registrationHistory: (json['registration_history'] as List)
          ...
          .toList(),
      hospitalPrevilages: json['hospital_previlages'].cast<String>() ,
      insurancePlansAccepted: json['insurance_plans_accepted'].cast<String>()
    );
  }
}
...
class PostgraduateTraining {
  ...
  factory PostgraduateTraining.fromJson(Map<String, dynamic> json) {
